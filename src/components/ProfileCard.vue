      ...
      <div class="w-full truncate">
        <p class="font-bold text-lg text-gray-800 dark:text-gray-100 truncate" :title="profile.name">
         ...
         <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
          ...
          <button @click="emit('edit')" class="p-1.5 rounded-full hover:bg-gray-500/10 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200" title="编辑" aria-label="编辑">
          ...
          <button @click="emit('delete')" class="p-1.5 rounded-full hover:bg-red-500/10 text-gray-400 hover:text-red-500" title="删除" aria-label="删除">
