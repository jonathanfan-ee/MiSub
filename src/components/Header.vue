    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
        ...
        <div v-if="isLoggedIn" class="flex items-center space-x-4">
          <button @click="uiStore.show()" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white transition-colors" title="设置" aria-label="设置">
          ...
          <button @click="emit('logout')" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white transition-colors" title="登出" aria-label="登出">
